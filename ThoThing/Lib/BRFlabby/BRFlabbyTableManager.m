...
- (void)removeOb:(UITableView *)tbv
{
    [tbv removeGestureRecognizer:_tapGestureRecognizer];
    [tbv removeGestureRecognizer:_longPressGestureRecognizer];
    [tbv removeGestureRecognizer:_panGestureRecognizer];
    [tbv removeObserver:self forKeyPath:flabbyKeyPath];
}
