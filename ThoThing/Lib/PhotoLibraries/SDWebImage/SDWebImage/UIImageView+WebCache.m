...
- (void)sd_setImageWithString:(NSString *)aUrl completed:(SDWebImageCompletionBlock)completedBlock {
    [self sd_setImageWithURL:[NSURL URLWithString:aUrl] placeholderImage:nil options:0 progress:nil completed:completedBlock];
}
