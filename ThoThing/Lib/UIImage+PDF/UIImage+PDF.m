...
//        //ym이 추가한곳 (pdf 백그라운드가 투명하게 나와서 그림만 하얗게 나오고 나머진 거멓게 나오는거 수정) 여기
        CGRect rect = CGRectMake(0, 0, 10000, 10000);
        CGContextSetRGBFillColor(ctx, 255.0f/255.0f, 255.0f/255.0f, 255.0f/255.0f, 1.0f);
...
//        ////////////////////////////////////////
        ...
        CGImageRef image = CGBitmapContextCreateImage(ctx);
        pdfImage = [[UIImage alloc] initWithCGImage:image scale:screenScale orientation:UIImageOrientationUp];
//        pdfImage = [self simpleRemoveBackgroundColor:pdfImage];
...
//        CGContextClipToMask(context, rect, pdfImage.CGImage);
...
+ (UIImage *)simpleRemoveBackgroundColor:(UIImage *)image
{
